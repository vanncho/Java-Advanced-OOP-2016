...
public class CoreCommandsImpl implements CoreCommands {

    private CoreDataBase<Core> coreDb;
    private CoreCreator coreFactory;

    public CoreCommandsImpl(CoreDataBase<Core> coreDb, CoreCreator coreFactory) {
        this.coreDb = coreDb;
    ...
    public Executable interpretCoreCommand(String[] data) {
        ...
        String path = Messages.CORE_COMMANDS_PACKAGE + commandName + "Command";
    ...
    private void injectDependencies(Executable executable, Class executableClass) throws IllegalAccessException {
        ...
        for (Field field : fields) {
            ...
            Field[] theseFields = CoreCommandsImpl.class.getDeclaredFields();
